export default function Lab1() {
    ...
    <li>Heat butter and oil in a pan, then sauté onions until golden.</li>
    <li>Add ginger-garlic paste and cook until fragrant.</li>
    <li>Stir in chopped tomatoes and cook until soft.</li>
    <li>Add cashews, then blend the mixture into a smooth paste.</li>
    <li>Return paste to the pan and cook with red chili powder, turmeric, coriander powder, and garam masala.</li>
    <li>Pour in water or milk and simmer to make a creamy gravy.</li>
    <li>Add paneer cubes and cook for 5 minutes.</li>
    <li>Finish with cream, kasuri methi, and garnish with coriander. Serve hot with naan or rice!</li>
    </ol>
    ...
    Please
    <a href="https://github.com/Killol392/kambaz-next-js" id="wd-github">click here</a>
    to get to kambaz project<br/>
    </div>
