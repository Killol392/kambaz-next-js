export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            Return paste to the pan and cook with red chili powder, turmeric,
          ...
          <li>
            Finish with cream, kasuri methi, and garnish with coriander. Serve
    ...
    anim id est laborum."
        ...
        {/* Professor asked not to do this exercise */}
        ...
        Please
        <a href="https://github.com/Killol392/kambaz-next-js" id="wd-github">
          click here
        </a>
        to get to kambaz project
        <br />
      </div>
    </div>
  );
